...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6285839350971@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
require('./jo2')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
...
sendMessage(`6285839350971@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `6285839350971@s.whatsapp.net`
}
}, options)
